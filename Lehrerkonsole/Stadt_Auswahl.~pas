...
//    procedure StringGridStadtSelectCell(Sender: TObject; ACol,
     // ARow: Integer; var CanSelect: Boolean);
  private
    { Private-Deklarationen }
  public
    Zellen_Farbe : Array of Integer;    //dynamisches Array
  end;
 ...
 var Anzahl_Verbindungen, i, k, Pos, z: Integer;
  begin
    ...
    With FormSpiel do            // Zugriff auf die nächste Form
      begin
         GridEinlesen();
         Spielzeit := Zeit;  //weist der Form die Zeitdauer extra zu!
         ...
         ProgressBarZeit.Max := Zeit;  //weist die PB entsprechend der Zeit zu! 
